    ...
    try {
      ...
      if (enrollmentData) {
        const formattedEnrollments = enrollmentData.map((enrollment) => ({
          ...
          course_title: enrollment.courses?.[0]?.title || "Unknown Course",
          teacher_name: enrollment.courses?.[0]?.profiles?.[0]?.full_name || "Unknown Teacher",
      ...
      if (gradeData) {
        const formattedGrades = gradeData.map((submission) => ({
          assignment_title: submission.assignments?.[0]?.title || "Unknown Assignment",
          course_title: submission.assignments?.[0]?.courses?.[0]?.title || "Unknown Course",
          grade: submission.grade || 0,
          max_points: submission.assignments?.[0]?.max_points || 0,
